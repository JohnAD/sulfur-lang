...
* Algorithmic restatement of procedures.
  ...
  TBD: create a small example that still survives the code-removal process

* Multi-lingual source code.

  Programmers are human. Humans speak multiple languages. The core of the language supports English, Mandarin Chinese, and Spanish at first. Ten languages have been chosen for later minimums.
...
* Multi-lingual UTF8 string handling.
  ...
  The users of an app are sometimes human. Humans speak multiple language. The support for both compile-time and run-time selection of translation will be supported in the very core and structure of the language.
...
* Somewhat larger vocabulary and learning time.
  ...
  There are more reserved keywords and structures than most language as Sulfur is attempting to gleam the "intent" of the code being written.
