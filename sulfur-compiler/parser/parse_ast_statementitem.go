...
//
// if parser every reaches the AST_STATEMENT_ITEM state, that probably means some kind of "binding" operation
// just completed. The correct behavior is to "finish" and pass the token to the statement parser to continue
// the parsing.
